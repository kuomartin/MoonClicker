...
/**
 * 一個在測試進程裡的 [IRelcV2Service]：把 Lua API 要求它做的事**記下來**，而不是真的做。
 *
 * 這是整套 Lua 測試的支點。`IRelcV2Service` 本來就是 Shizuku 的邊界，所以只要換掉它，
 ...
 * 別讓它靜靜地通過。
 */
internal class RecordingRelcService(
    ...
    private fun unused(name: String): Nothing =
        throw UnsupportedOperationException("RecordingRelcService.$name is not part of this tier")
}
